      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in">
            Discover Nepal with 
            <span className="text-yellow-400 block">Prabas Travels</span>
          </h1>
          
          <p className="text-xl md:text-2xl mb-8 opacity-90">
            Your trusted travel partner for unforgettable journeys across Nepal and beyond. 
            Experience the beauty of the Himalayas with our expert guidance.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" className="text-lg px-8 py-4 bg-yellow-600 hover:bg-yellow-700">
              Explore Packages
            </Button>
